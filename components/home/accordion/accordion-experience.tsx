        ...
        return (
          <div key={index} className="flex flex-row gap-4 mb-5">
            ...
            <div className="flex flex-col gap-1 pb-5">
              ...
              <ul className="flex flex-wrap gap-2 mt-2 text-sm text-muted-foreground">
              ...
              <div className="flex flex-wrap gap-2 mt-2">
                {job.skills.map((skill) => (
                  <span
                    key={skill}
                    className="text-sm items-center justify-center py-1 px-4 shadow-xs bg-primary-foreground rounded-lg text-center"
                  >
                    {skill}
                  </span>
                ))}
